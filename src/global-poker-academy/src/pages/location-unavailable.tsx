    ...
    <div className="location-unavailable--container">
      ...
      <div className="location-unavailable--text-area">
        ...
        <div className="location-unavailable--info-text">
          Global Poker is currently only available in the United States (except WA state) and Canada
          (except Quebec). Please contact support for any additional questions.
        </div>
