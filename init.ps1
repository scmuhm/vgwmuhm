...
try {
    ...
    & $mkcert -install
    & $mkcert "*.global-poker-academy.localhost"
...
Add-HostsEntry "www.global-poker-academy.localhost"
...
if ($InitEnv) {
    ...
    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.global-poker-academy.localhost"
